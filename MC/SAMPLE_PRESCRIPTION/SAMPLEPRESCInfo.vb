...
Namespace MC
    ...
    <Serializable()> _
    Public Class SAMPLEPRESCInfo
        Inherits Csla.ReadOnlyBase(Of SAMPLEPRESCInfo)
...
#Region " Business Properties and Methods "
        ...
        Public ReadOnly Property BeforeLunch() As Boolean
            Get
        ...
        Public ReadOnly Property BeforeSupper() As Boolean
            Get
        ...
        Public ReadOnly Property BeforeDinner() As Boolean
            Get
...
#Region " Factory Methods "
        ...
        Friend Shared Function GetSAMPLEPRESCInfo(ByVal dr As SafeDataReader) As SAMPLEPRESCInfo
            Return New SAMPLEPRESCInfo(dr)
        End Function
